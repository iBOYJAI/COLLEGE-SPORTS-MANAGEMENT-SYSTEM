...
/**
 * Staff Certificate Generation - High Fidelity Layout (Admin Parity)
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        logActivity($conn, 'create', 'certificates', $cert_id, "Staff Generated credential: $certificate_type");
...
<style>
    /* Base Certificate Styles from Admin side */
    .certificate-paper {
        background: white;
        padding: 40px;
        color: #1e293b;
    ...
    /* PARTICIPATION CERTIFICATE - BLUE/SLATE THEME */
